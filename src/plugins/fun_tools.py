...
SHOWCASES: dict[str, list[tuple[str, str]]] = {
    "今日分院": [
        ("小明", "@鲸娘 今日分院"),
        ("鲸娘", "@小明 鲸鱼尾巴轻轻一甩，命运已定……格兰芬多！"),
    ],
    "判刑": [
        ("小明", "@鲸娘 /判刑 @小红 3"),
        ("鲸娘", "已将 QQ 小红 押去海底牢房服刑 3 小时。"),
    ],
    "赦免": [
        ("小明", "@鲸娘 /赦免 @小红"),
        ("鲸娘", "已赦免 QQ 小红，快游回来吧～"),
    ...
    "重新分院": [
        ("小明", "@鲸娘 /重新分院"),
        ("鲸娘", "重新甩甩尾巴听听命运……嗯……赫奇帕奇！"),
    ],
    "op": [
        ("小明", "@鲸娘 /op @小红"),
        ("鲸娘", "已给 QQ 小红 授予 OP 权限。"),
    ],
    "suop": [
        ("小明", "@鲸娘 /suop"),
        ("鲸娘", "已给本群 3 位管理员/群主授予 OP 权限。"),
    ],
    "deop": [
        ("小明", "@鲸娘 /deop @小红"),
        ("鲸娘", "已取消 QQ 小红 的 OP 权限。"),
    ],
    "贴猴": [
        ("小明", "@鲸娘 /贴猴 @小红"),
        ("鲸娘", "已给 QQ 小红 贴上 🐵，他每发一条消息我都会贴一个 🐵 表情。"),
    ],
    "贴猪": [
        ("小明", "@鲸娘 /贴猪 @小红"),
        ("鲸娘", "已给 QQ 小红 贴猪，他每发一条消息我都会贴一个 ㊗️ 表情。"),
    ],
    "小猪": [
        ("小明", "/小猪"),
        ("鲸娘", "（随机发送一张 PigHub 的可爱小猪图片）"),
    ],
    "问答": [
        ("小明", "/问答\n问\n鲸娘是傻子吗\n答\n不是，我是最聪明的小鲸鱼"),
        ("鲸娘", "我记住了。"),
    ...
    "忘记": [
        ("小明", "/忘记\n鲸娘是傻子吗"),
        ("鲸娘", "已忘记 1 条关于「鲸娘是傻子吗」的问答。"),
    ],
    "省流": [
        ("小明", "/省流"),
        ("鲸娘", "省流版：大家聊了分院、海底牢房和今晚的鲸鱼夜谈……"),
    ],
    "入典": [
        ("小明", "（回复一条消息）入典"),
        ("鲸娘", "（已入典）"),
    ...
    "射": [
        ("小明", "（引用一张图片）射"),
        ("鲸娘", "（返回该图白色涂料喷溅 GIF；可加参数：数量 大小 黏稠 起点 不透明度 颜色）"),
    ],
    "reset": [
        ("小明", "/reset"),
        ("鲸娘", "好的，我已经忘记之前说过的话，重新开始吧～"),
    ],
    "help": [
        ("小明", "/help"),
        ("鲸娘", "我是【鲸娘】……指令：/今日分院 /判刑 /赦免 ……"),
    ],
    "展示": [
        ("小明", "/展示 /判刑"),
        ("鲸娘", "（用合并转发展示一段演示对话）"),
